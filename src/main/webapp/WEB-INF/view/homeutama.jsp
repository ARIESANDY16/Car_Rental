...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark warna">
		<a class="navbar-brand" href="#"><img src="images/download.png" /></a>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">Sewa Mobil Dengan Supir</a> <a
							class="dropdown-item" href="#">Sewa Mobil Lepas Kunci</a>
					</div></li>
	...
	<div id="carouselExampleControls" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="images/featured-img-2.jpg" class="d-block w-100" alt="..."
					style="height: 85vh; object-fit: cover" />
			</div>
			<div class="carousel-item">
				<img src="images/featured-img-3.jpg" class="d-block w-100" alt="..."
					style="height: 85vh; object-fit: cover" />
			</div>
		</div>
		<div>
